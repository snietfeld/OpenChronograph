...
Generates copper and soldermask SVGs for an FDAI dial.
'''
import svgwrite
...
def draw_fdai(fname, od=36.7, lw_minor=0.1524, lw_major=0.25,
...
if __name__ == '__main__':
    draw_fdai('fdai_copper.svg', od=36.7, lw_minor=0.1524, lw_major=0.25,
              upper_color='black', lower_color='black')

    draw_fdai('fdai_soldermask.svg', od=36.7, lw_minor=0.1524*2, lw_major=0.25*2,
              upper_color='black', lower_color='black')
